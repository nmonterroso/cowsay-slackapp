...
/*Cowsay swagger:route POST / defaultop cowsay

Respond to a Slack cowsay command

Respond to a Slack cowsay (`/cowsay`) command and send the requested message to the channel in which the command was posted
